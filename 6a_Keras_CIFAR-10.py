...
model_load = load_model('checkpoints/cifar_keras/cifar.keras')
...
weights_conv1 = layer_conv_bn.get_weights()
weights_conv2 = layer_conv2.get_weights()

layer_output1 = Model(inputs=layer_input.input, outputs=layer_conv_bn.output)
layer_output2 = Model(inputs=layer_input.input, outputs=layer_conv2.output)
