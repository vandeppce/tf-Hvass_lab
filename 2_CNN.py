...
# print(layer_conv1)         # shape=(?, 14, 14, 16)
...
# print(layer_conv2)           # shape=(?, 7, 7, 36)

# transform
layer_flat, num_features = flatten_layer(layer_conv2)
# print(layer_flat)              # shape=(?, 1764)
...
def plot_conv_weights(weights, input_channel = 0):
    ...
    for i, ax in enumerate(axes.flat):
        ...
        if i < num_filters:
            # Get the weights for the i'th filter to the input channel
